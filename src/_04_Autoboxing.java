public class _04_Autoboxing {
    public static void main(String[] args) {
        ...
        System.out.println(new Integer(10) == new Integer(10)); // porównuje obiekty - to co innego (false)
        System.out.println(new Integer(10).equals(new Integer(10))); // porównywnie obiektów
    }
}
